...
class YesterdayWidget extends StatefulWidget {
  const YesterdayWidget({super.key});

  @override
  State<YesterdayWidget> createState() => _YesterdayWidgetState();
}

class _YesterdayWidgetState extends State<YesterdayWidget> {
  String? golongan;
  bool loading = false;
  List result = [];
  String? _empty;
  ...
  Future<void> loadData() async {
    try {
      ...
      final response = await http.post(
          Uri.parse("http://ulayyasoft.my.id/sdm/personil/kemarin"),
